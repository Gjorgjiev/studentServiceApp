...
public class TableElektro extends JFrame {
	...
	public TableElektro() {
		...
		comboBox.addItem("Power_engineering_automation_and_renewable_energy_sources");
		comboBox.addItem("Power_systems");
		comboBox.addItem("Power_engineering_and_management");
		comboBox.addItem("Computer_system_engineering_automation_and_robotics");
		comboBox.addItem("Computer_technologies_and_engineering");
		comboBox.addItem("Computer_hardware_engineering_and_electronics");
		comboBox.addItem("Telecommunication_and_information_engineering");
